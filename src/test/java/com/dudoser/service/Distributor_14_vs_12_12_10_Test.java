...
public class Distributor_14_vs_12_12_10_Test extends DistributorBaseTest {
    ...
    public Distributor_14_vs_12_12_10_Test() {
    ...
    private static Set<Hero> prepareHeroSet() {
        ...
        heroesSet.add(new Hero(new Random().nextInt()*1000, Level.FOURTEEN, Bild.ATTACK));
        return heroesSet;
    }

    private static List<Integer[]> initExpectedTeamCountSequenceList() {
        List<Integer[]> expectedTeamCountSequence = new ArrayList<>();
        expectedTeamCountSequence.add(new Integer[]{1, 3}); //TODO, assert(check) levels and amount in team
